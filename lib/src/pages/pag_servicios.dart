...
class Pag_servicios extends StatelessWidget {
  const Pag_servicios({Key? key}) : super(key: key);
...
// ignore: camel_case_types
class pag_servicios extends StatefulWidget {
  const pag_servicios({Key? key}) : super(key: key);

  @override
  State<pag_servicios> createState() => _pag_serviciosState();
}

// ignore: camel_case_types
class _pag_serviciosState extends State<pag_servicios> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
  ...
  return Stack(
    ...
    children: <Widget>[
      ...
      Positioned(
        ...
        left: 0,
        right: 0,
      child: Image.asset('assets/ImagenServi.jpeg',
...
Widget medicamentosG() {
  return Positioned(
    ...
    child: InkWell(
      ...
      child: Image.asset(
        'assets/Guarderias.jpeg', // Ruta de la imagen              
...
Widget juguetesG() {
  return Positioned(
    ...
    child: InkWell(
      ...
      child: Image.asset(
        'assets/ConsultaCas.jpeg', // Ruta de la imagen              
...
Widget accesoriosG() {
  return Positioned(
    ...
    child: InkWell(
      ...
      child: Image.asset(
        'assets/ConsultaVir.jpeg', // Ruta de la imagen              
          width: 150, // Ancho de la imagen superpuesta
          height: 150, // Alto de la imagen superpuesta
      ),
    ),
